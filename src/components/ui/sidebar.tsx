  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "fixed inset-y-0 z-10 hidden h-svh w-[--sidebar-width] duration-0 ease-linear md:flex",
            side === "left"
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 outline-none ring-sidebar-ring duration-0 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
